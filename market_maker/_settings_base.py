...
API_KEY = "DRWniFVS1opBSMGm5f8tgqPp"
API_SECRET = "rNV1KtiGQyHUCcK8jpmyXdgLg2133KVhh6-ZlVzysIA9HMkW"
...
WATCHED_FILES = [join('market_maker', 'market_maker.py'), join('market_maker', 'bitmex.py'), 'market_maker/settings.py']
